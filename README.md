...
| `columnHeaderTextStyle`        | Text style for the column header cells.                                                     |
...
| `dataTextStyle`                | Text style for the data cells.                                                              |
| `errorColor`                   | Color used to indicate errors in the table.                                                 |
| `rowErrorIndicationWidth`      | Width of the error indication bar for rows.                                                 |
...
| `columnHeaderDividerColor`     | Color of dividers between column headers (optional styling option).                         |
| `dataUpdatePolicy`             | Policy for updating data in the table.                                                      |
| `sortIconProvider`             | Function to provide a custom sort icon for column headers.                                  |
| `onCellLongPress`              | Callback when a cell is long-pressed.                                                       |
| `onCellAction`                 | Callback when a cell action is triggered.                                                   |
| `onHeaderActionTriggered`      | Callback when a header action is triggered.                                                 |
| `rootComposeView`              | ComposeView for integration with RecyclerView (optional).                                   |
